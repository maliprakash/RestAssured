 ...
 // @Test
	public void basic_01() {
		...
		// encode credentials using Base64
			String credentials = "restassuredpractice@gmail.com : api@1234";	
	       byte[] encodedcredentials = Base64.encodeBase64(credentials.getBytes());
		
	       String encodedcredentialsString = new String(encodedcredentials);
	       
		RequestSpecBuilder specBuilder = new RequestSpecBuilder();
		specBuilder.setBaseUri("https://bookstore.toolsqa.com")	
		.setBasePath("/BookStore/v1/Books")
		.setContentType(ContentType.JSON)
		.addHeader("Authorization","Basic "+encodedcredentialsString);
