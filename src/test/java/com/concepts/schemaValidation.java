...
public class schemaValidation {
		...
		ValidatableResponse validatableRes = response.then();
		            ...
		            String extractResponseBody = validatableRes.log()
		                                              .all()
		                                              .extract()
		                                              .response()
		                                              .asString();
     // in .json file in resource folder then use =  JsonSchemaValidator.matchesJsonSchemaInClasspath...use direct file name
     // insted of complete path
