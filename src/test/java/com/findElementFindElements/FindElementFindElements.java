...
public class FindElementFindElements {
	...
	public void response() throws IOException {
		// this file considered as response
byte[] consideAsResponseFile = Files.readAllBytes(Paths.get("C:\\Users\\DELL\\eclipse-workspace\\RApi01\\target\\JsonFilePayload\\json02.json"));
